...
import { getWorldSetting, saveWorldSetting, getStoryHistory, ingestFile } from "@/lib/api";
import type { WorldSetting, StoryHistory } from "@/types";
...
function WorldTab() {
  ...
  async function handleFileUpload(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    setUploading(true);
    try {
      await ingestFile(file, "world");
      const fresh = await getWorldSetting();
      setSetting(fresh);
